...
namespace CombineFiles.Core.Helpers
{
    public static class FileFilterHelper
    {
        ...
        // Nota: FilterByDateAndSize e FileContainsAutoGenerated sono stati spostati in FileFilterService
        // Mantenuti qui per retrocompatibilità (deprecati)
        
        /// <summary>
        /// [Obsolete] Usare FileFilterService.FilterFiles invece.
        ...
        {
            var filterService = new CombineFiles.Core.Services.FileFilterService(logger);
            return filterService.FilterFiles(files, options);
        }

        /// <summary>
        /// [Obsolete] Usare FileFilterService.FileContainsAutoGenerated invece.
        ...
        {
            var filterService = new CombineFiles.Core.Services.FileFilterService(logger);
            return filterService.FileContainsAutoGenerated(filePath);
        }
    }
}
